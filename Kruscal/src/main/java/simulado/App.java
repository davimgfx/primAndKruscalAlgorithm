...
public class App {
    public static void main(String[] args) {
        ...
        App graph = new App();	//CAREFUL: nodeCount must be correct. No error checking between nodeCount & graphEdges to see how many nodes actually exist
